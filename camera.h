    ...
    class Camera1
    {
     public:
        ...
        void Set(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up)
        {
            ...
            distanceToTarget =distance( position ,center);
        }
//        void FollowTank(const Player& tank)
//        {
//            // Calculate the camera position behind the tank
//            glm::vec3 offset = -2.0f * tank.getForward() + glm::vec3(0, 1.0f, 0); // Adjust the vertical position
//            position = tank.getPosition() + offset * distanceToTarget;
//
//            // Look at the tank
//            SetTarget(tank.getPosition());
//
...
//        }
        ...
        void TranslateRight(float distance)
        {
            ...
            glm::vec3 dir = glm::normalize(glm::cross(glm::vec3(forward.x, forward.y, forward.z), glm::vec3(up.x, up.y, up.z)));
            position += dir * distance;
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            up = glm::normalize(glm::cross(right, forward));
            right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1), angle, right)*glm::vec4(right, 1)));
